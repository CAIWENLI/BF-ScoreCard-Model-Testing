select * from  SCO.CYL_CAR_BASE_N t
----------------------------------------------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------------------------------------------
---------------------------------------------------------  车贷评分卡（张双版）   ---------------------------------------------------------------
----------------------------------------------------------------------------------------------------------------------------------------
...
/**********************************************************************************
    ...
    * 版本：V1.0
**********************************************************************************/
select * from sco.jn_car_column;--字典表
select * from sco.zs_car_bining_pre_add_v1;--粗分配置表（等宽分组）
select * from sco.zs_car_var_property_add_v1;--粗分变量单一值处理
select * from sco.zs_CAR_var_pre_v2;--细分组配置表（手动分箱）
